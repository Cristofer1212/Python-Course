...
def handle_radio_event():
    label.config(text="Opción elegida: " + str(var.get()))

# Creación de la variable para los botones de radio
var = tk.IntVar()
...
label = tk.Label(root, text=" ¡Bienvenido! Selecciona tus opciones ")
label.pack()
