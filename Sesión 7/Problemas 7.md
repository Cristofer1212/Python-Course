...
En el caso de que sean más de las 7, se mostrará un mensaje de ir a casa y en caso contrario, haréis una operación para calcular el tiempo que queda de trabajo. 
